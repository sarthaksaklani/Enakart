// src/components/products/ResellerProductCard.tsx
...
interface ResellerProductCardProps {
  product: Product;
}
...
export const ResellerProductCard: React.FC<ResellerProductCardProps> = ({ product }) => {
        ...
        <div className="relative bg-zinc-900 rounded-md overflow-hidden group cursor-pointer transition-all duration-300 border-2 border-transparent hover:border-red-600">
          ...
          <div className="relative h-40 sm:h-48 bg-zinc-800 overflow-hidden">
            ...
            <div className="absolute top-1.5 sm:top-2 left-1.5 sm:left-2 flex flex-col gap-1 sm:gap-1.5 z-10">
              {discount > 0 && (
                <span className="bg-red-600 text-white text-[9px] sm:text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                  {discount}% OFF
                </span>
              )}
              {product.is_featured && (
                <span className="bg-yellow-500 text-black text-[9px] sm:text-xs font-bold px-1.5 sm:px-2 py-0.5 sm:py-1 rounded shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                  ⭐ FEATURED
                </span>
              )}
            </div>
            ...
            {/* Wishlist Button */}
            <button
              className="absolute top-1.5 sm:top-2 right-1.5 sm:right-2 bg-black/60 backdrop-blur-sm p-1.5 sm:p-2 rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-600 hover:scale-110 transition-all duration-300 z-10"
              onClick={(e) => {
                e.preventDefault();
          ...
          <div className="p-2 sm:p-3 space-y-1 sm:space-y-1.5">
            ...
            {/* Share Buttons - Shows on hover */}
            <div className="pt-1 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
              <div className="flex gap-2">
                {/* WhatsApp Share Button */}
                <Button
                  className="flex-1 bg-green-500 hover:bg-green-600 text-white font-bold text-xs sm:text-sm py-1.5 sm:py-2 rounded shadow-lg hover:shadow-green-500/50 transition-all duration-300"
                ...
                <Button
                  className="bg-zinc-700 hover:bg-zinc-600 text-white font-bold text-xs sm:text-sm p-1.5 sm:p-2 rounded shadow-lg transition-all duration-300"
